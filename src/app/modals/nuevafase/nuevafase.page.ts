...
export class NuevafasePage implements OnInit {
  ...
  agregaranuncio(){
    var databeoboxagregaranuncio = {
      nombre_solicitud:'beoboxagregaranuncio',
      titulo: this.titulo,
      mensaje: this.mensaje,
      prioridad: this.prioridad
    }

    this.variosservicios.variasfunciones(databeoboxagregaranuncio).subscribe(async( res: any ) =>{
      console.log('respuesta de beoboxagregaranuncio', res);
      if(res.id>0){
